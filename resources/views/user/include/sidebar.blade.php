...
<div class="w-[25%]">
    <ul class="flex-column w-full mt-10 space-y space-y-4 text-sm font-medium text-gray-500 md:me-4 mb-4 md:mb-0">
        ...
        <li>
            <a href="#" data-tab="dashboard" class="tab-link inline-flex justify-center items-center px-4 py-3 ml-9 rounded-lg hover:text-gray-900 hover:bg-gray-100 w-[80%]">
                ...
                <i class="fa-regular fa-star w-4 h-4 me-2"></i>
                Become a creator
            </a>
        </li>

        <li>
            <a href="#" data-tab="contact" class="tab-link inline-flex items-center ml-9 justify-center px-4 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 w-[80%]">
                ...
                <div class="ml-4">
                    <i class="fa-solid fa-money-bill w-4 h-4 me-1.5"></i>
                    <span class="pr-2">Bills and payments</span>
        ...
        <li>
            <a href="#" data-tab="settings" class="tab-link inline-flex items-center justify-center ml-9 px-4 py-3 rounded-lg hover:text-gray-900 hover:bg-gray-100 w-[80%]">
        ...
        {{-- <li>
            <a class="inline-flex items-center px-4 py-3 text-gray-400 rounded-lg cursor-not-allowed bg-gray-50 w-full">
